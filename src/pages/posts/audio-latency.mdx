...
I'm not 100% on this, but I believe you want Windows to use its native audio drivers if you want the best possible latency. As mentioned earlier, before I did this my optical & monitor's 3.5mm results were 90ms~, while my usb results were 75ms~. After fixing my drivers they went down to 41ms/35ms~.
