...
You'll also want to use a hardware-accelerated browser. [Thorium](https://thorium.rocks/) is what I've seen recommended, and is what I used in my testing. It doesn't seem to work at all on Firefox.
