...
I recently watched [techless' video on audio latency](https://www.youtube.com/watch?v=okIpbu1tp_A), which opened my eyes to how horrible audio latency is on Windows. This led me down a rabbit hole, and eventually I managed to drop my audio latency by over 50ms, with it ending up at around 35ms~ in tests. This is about as good as it can get from what I've seen.
...
I'm not 100% on this, but I believe you want Windows to use its native audio drivers if you want the best possible latency. As mentioned earlier, before I did this my optical & monitor's 3.5mm results were 90ms~, while my usb results were 75ms~. After fixing my drivers they went down to 45ms/35ms~.
