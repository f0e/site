...
I recently watched [techless' video on audio latency](https://www.youtube.com/watch?v=okIpbu1tp_A), which opened my eyes to how horrible audio latency is on Windows. This led me down a rabbit hole, and eventually I managed to drop my audio latency from 100ms~ to 45ms~. This is about as good as it can get from what I've seen.
